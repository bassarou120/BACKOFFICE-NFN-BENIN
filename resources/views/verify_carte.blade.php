...
<div class="container my-5"  >
    ...
    <div class="container mt-5">
        <h1 class="text-center" id="top">Authentification de la carte de membre </h1>
{{--        <p class="text-center">Consulter le statut en remplissant le formulaire ci-dessous.</p>--}}
...
{{--        </div>--}}
        ...
        <form id="statusForm" class="" enctype="multipart/form-data" >
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if($carte !=null)
                        ...
                        <div id="show-alert-bravo" style="" class="alert alert-success alert-dismissible fade show" role="alert">
                            <strong>BRAVO !</strong>   <span id="message-bravo">votre carte est authentque</span>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    @else


                        <div id="show-alert-rejeter"   class="alert alert-danger alert-dismissible fade show" role="alert">
                            <strong>ATTENTION !</strong>   <span id="message-rejeter"> Votre Carte membre n'est pas Authentique</span>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    ...
                    <img src="{{$carte}}" width="500" style="border: solid" alt="">

{{--                    <div class="row g-3">--}}
{{--                        <div class="col">--}}
{{--                            <label for="identifiant" class="form-label">Tapez votre numero d'ahession</label>--}}
{{--                            <input type="text" name="identifiant" value="{{$identifiant}}" class="form-control " id="identifiant" placeholder="Ex: 02GOG00089 " aria-label="Identifiant" required>--}}
{{--                        </div>--}}
{{--                        <div class="col">--}}
{{--                            <label for="telephone" class="form-label">.</label>--}}
{{--                            <br>--}}
{{--                            <button type="submit" class="btn btn-primary btn-block" style="background-color: #f06f19;">Verifier</button>--}}
{{--                        </div>--}}
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success==true) {
                            ...
                            if (response.message==="EN ATTENTE DE VALIDATION"){

                                $('#message-attente').html("<p>Status : EN ATTENTE DE VALIDATION</p>");
                                $('#show-alert-en-attente').show();
                                $('#statusForm')[0].reset();
                            ...
                            if (response.message==="EN ATTENTE DE CONFIRMATION"){

                                $('#message-attente').html("<p>Status : EN ATTENTE DE CONFIRMATION.</p>");
                                $('#show-alert-en-attente').show();
                                $('#statusForm')[0].reset();
                            ...
                            if (response.message==="APPROUVER"){

                                $('#message-bravo').html("<p>Votre adhésion à la NFN est définitivement validée.</p>");
